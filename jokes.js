let arr= [` What does a cloud wear under his raincoat?
Thunderwear.`,
...
// // joke.innerHTML = arr[index].joke
// joke.innerHTML = index

let y= Math.floor(Math.random()*78);
document.getElementById("joke").innerText = arr[y]